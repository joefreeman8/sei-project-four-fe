      ...
      <div className="bg-pawhub-yellow flex justify-center items-center p-5 flex-col">
        <div className="bg-white w-5/6 m-3 p-6 shadow-xl xl:w-2/3">
          <div className={`flex justify-between ${isAuth && 'lg:justify-around'}`}>
            ...
            {isAuth &&
                  <a onClick={handleFavorite}><img src={!isFavorited ? emptyHeart : fullHeart} className="favorite-heart w-10 h-10" /></a>
            }
          </div>
              ...
              <div key={question.id} className="w-5/6 m-2 shadow-lg p-2 rounded-md">
                ...
                {isOwner(getUserId()) ?
                  <div className="flex flex-col items-end">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 delete-question" fill="none" viewBox="0 0 24 24" stroke="currentColor" onClick={handleDelete} id={question.id}>
