      ...
      <div className="bg-pawhub-yellow flex flex-col justify-center items-center p-5">
        <div className="bg-white w-5/6 m-3 p-6 shadow-xl">
          <div className="flex lg:start">
            ...
            <div className="columns-1 w-4/6">
              <h1 className="gooddog-font text-5xl">Alex Chan</h1>
        ...
        <div className="bg-white w-5/6 m-3 p-6 shadow-xl">
          <div className="flex lg:start">
            ...
            <div className="columns-1 w-4/6">
              <h1 className="gooddog-font text-5xl">Alex Theoklitou</h1>
        ...
        <div className="bg-white w-5/6 m-3 p-6 shadow-xl">
          <div className="flex lg:start">
            ...
            <div className="columns-1 w-4/6">
              ...
              <p>My name is Joe and i like cheese and pickle sandwiches. My name is Joe and i like cheese and pickle sandwiches. My name is Joe and i like cheese and pickle sandwiches. My name is Joe and i like cheese and pickle sandwiches.</p>
            </div>
          </div>
        </div>
        <div className="bg-white w-5/6 m-3 p-6 shadow-xl">
