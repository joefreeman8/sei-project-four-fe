...
function Fundraiser() {
  return (
    <>
      ...
      <div className="fundraiser-background h-full w-full bg-center bg-cover"><img src="https://i.imgur.com/Bm9jKXC.jpg" /></div>
      <div className="bg-white/50 h-3/6 w-full flex flex-col justify-center items-center p-5 -mt-32 z-2">
        <h3 className="text-5xl kessel-font">New Rescue Centre</h3>
        ...
        <p className="mt-10 text-align-middle">
          If you want to help raise money in collaboration PawHub please email the team at directly at <a className="underline" href="#">fundraiser@pawhub.dog</a> and somebody will be ready to assist.
        </p>
      </div>
