      ...
      <div className="pt-1 pb-10">
        ...
        <form className="bg-white shadow-xl rounded w-5/6 mx-auto mt--10 px-10 pt-5 pb-5">
          ...
          <div className="mb-6">
            ...
            <fieldset>
              <label htmlFor="text" className="block mb-0 text-sm font-medium text-gray-900">26. Have you owned a dog previously?<span className="text-red-600"> *</span></label>
              <div className="flex items-center mb-0">
                <input id="owned-before-1" aria-describedby="owned-before-1" type="checkbox" className="w-4 h-4 text-pawhub-yellow bg-gray-100 rounded border-black focus:border-pawhub-yellow focus:ring-2 "/>
                <label htmlFor="owned-before-1" className="ml-3 text-sm font-medium text-gray-900">As a child</label>
              </div>

              <div className="flex items-center mb-0">
                <input id="owned-before-2" aria-describedby="owned-before-2" type="checkbox" className="w-4 h-4 text-pawhub-yellow bg-gray-100 rounded border-black focus:border-pawhub-yellow focus:ring-2 "/>
                <label htmlFor="owned-before-2" className="ml-3 text-sm font-medium text-gray-900">As an adult</label>
              </div>

              <div className="flex items-center mb-0">
                <input id="owned-before-3" aria-describedby="owned-before-3" type="checkbox" className="w-4 h-4 text-pawhub-yellow bg-gray-100 rounded border-black focus:border-pawhub-yellow focus:ring-2 "/>
            ...
            <fieldset>
              <label htmlFor="text" className="block mb-0 text-sm font-medium text-gray-900">27. What dog size are you looking for?<span className="text-red-600"> *</span></label>
              <p className="text-black text-xs italic mb-0">Select all the apply</p>
              <div className="flex items-center mb-0">
                <input id="size-option-1" aria-describedby="size-option-1" type="checkbox" className="w-4 h-4 text-pawhub-yellow bg-gray-100 rounded border-black focus:border-pawhub-yellow focus:ring-2 "/>
                <label htmlFor="size-option-1" className="ml-3 text-sm font-medium text-gray-900">Small</label>
              </div>

              <div className="flex items-center mb-0">
                <input id="size-option-2" aria-describedby="size-option-2" type="checkbox" className="w-4 h-4 text-pawhub-yellow bg-gray-100 rounded border-black focus:border-pawhub-yellow focus:ring-2 "/>
                <label htmlFor="size-option-2" className="ml-3 text-sm font-medium text-gray-900">Medium</label>
              </div>

              <div className="flex items-center mb-0">
                <input id="size-option-3" aria-describedby="size-option-3" type="checkbox" className="w-4 h-4 text-pawhub-yellow bg-gray-100 rounded border-black focus:border-pawhub-yellow focus:ring-2 "/>
            ...
            <fieldset>
              <label htmlFor="text" className="block mb-0 text-sm font-medium text-gray-900">28. What gender of dog are you looking for?<span className="text-red-600"> *</span></label>
              <p className="text-black text-xs italic mb-0">Select all the apply</p>
              <div className="flex items-center mb-0">
                <input id="gender-option-1" aria-describedby="gender-option-1" type="checkbox" className="w-4 h-4 text-pawhub-yellow rounded border-black focus:border-pawhub-yellow focus:ring-2 "/>
                <label htmlFor="gender-option-1" className="ml-3 text-sm font-medium text-gray-900">Male</label>
              </div>

              <div className="flex items-center mb-0">
                <input id="gender-option-2" aria-describedby="gender-option-2" type="checkbox" className="w-4 h-4 text-pawhub-yellow bg-gray-100 rounded border-black focus:border-pawhub-yellow focus:ring-2 "/>
            ...
            <fieldset>
              <label htmlFor="text" className="block mb-0 text-sm font-medium text-gray-900">29. What age dog are you looking for?<span className="text-red-600"> *</span></label>
              <p className="text-black text-xs italic mb-0">Select all the apply</p>
              <div className="flex items-center mb-0">
                <input id="age-option-1" aria-describedby="age-option-1" type="checkbox" className="w-4 h-4 text-pawhub-yellow bg-gray-100 rounded border-black focus:border-pawhub-yellow focus:ring-2 "/>
                <label htmlFor="age-option-1" className="ml-3 text-sm font-medium text-gray-900">Under 6 months</label>
              </div>

              <div className="flex items-center mb-0">
                <input id="age-option-2" aria-describedby="age-option-2" type="checkbox" className="w-4 h-4 text-pawhub-yellow bg-gray-100 rounded border-black focus:border-pawhub-yellow focus:ring-2 "/>
                <label htmlFor="age-option-2" className="ml-3 text-sm font-medium text-gray-900">6-18 months</label>
              </div>

              <div className="flex items-center mb-0">
                <input id="age-option-3" aria-describedby="age-option-3" type="checkbox" className="w-4 h-4 text-pawhub-yellow bg-gray-100 rounded border-black focus:border-pawhub-yellow focus:ring-2 "/>
                <label htmlFor="age-option-3" className="ml-3 text-sm font-medium text-gray-900">18 months plus</label>
              </div>

              <div className="flex items-center mb-0">
                <input id="age-option-4" aria-describedby="age-option-2" type="checkbox" className="w-4 h-4 text-pawhub-yellow bg-gray-100 rounded border-black focus:border-pawhub-yellow focus:ring-2 "/>
